...
// About
Architecture Design Document based on the excellent _Arc42_ footnote:[Arc42 is created, maintained and (C) by Dr. Peter Hruschka, Dr. Gernot Starke and contributors. See https://arc42.org.] template.
